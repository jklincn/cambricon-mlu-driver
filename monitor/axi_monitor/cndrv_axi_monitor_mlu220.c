...
#define MLU220_HUB0_MONITOR_CNT 21


struct cn_axi_monitor_config mlu220_config[MLU220_MAX_AXI_MON_NUM] = {
	{MLU220_CPUGIC__CPUSYS_AXIMHUB_IRQ, MLU220_HUB0_MONITOR_CNT,
		0x24000, aximhub_mlu200_intr_handle, ((1ULL << MLU220_HUB0_MONITOR_CNT) - 1)},
};

struct cn_aximhub_ops aximon_mlu220_ops = {
	.stop_hub = axihub_mlu200s_stop_hub,
	.start_hub = axihub_mlu200s_start_hub,
};

struct cn_aximon_zone_info mlu220_zone_info = {
